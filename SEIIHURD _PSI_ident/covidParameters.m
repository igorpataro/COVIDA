...
for i=1:size(Dados,1)
     ...
     mse_c=mse_c+abs(Dados(i,1)-Nw(i));
     mse_h=mse_h+abs(Dados(i,2)-H(i));
     mse_u=mse_u+abs(Dados(i,3)-U(i));
     mse_d=mse_d+abs(Dados(i,4)-D(i));
     
end

mse_total=3*mse_c+5*mse_d+35*mse_h+35*mse_u;
