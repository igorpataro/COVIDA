...
for i=1:size(Q,1)
plot(tplotsbeforemodel,H(:,i),'LineWidth',3); grid on; hold on;
end
...
for i=1:size(Q,1)
plot(tplotsbeforemodel,U(:,i),'LineWidth',3); grid on; hold on;
end
...
for i=1:size(Q,1)
plot(tplotsbeforemodel(2:end),Nw_i(:,i),'LineWidth',3); grid on; hold on;
end
...
for i=1:size(Q,1)
plot(tplotsbeforemodel(2:end),(NwD_i(:,i)),'LineWidth',3); grid on; hold on;
end
...
for i=1:size(Q,1)
plot(tplotsbeforemodel,Psic(:,i),'LineWidth',3); grid on; hold on;
end
set(gca,'FontSize',20,'LineWidth',2,'FontWeight','Bold')
ylabel('Social Mobility Index')
xlim([tplotsbeforemodel(1) tplotsbeforemodel(end)])
ylim([0 1])
...
subplot(2,1,1)
for i=1:size(Q,1)
plot(tplotsbeforemodel,uc(:,i),'LineWidth',3); grid on; hold on;
end
