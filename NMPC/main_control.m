...
switch SCENARIO
    ...
    Q = [8e4 3e4 1e4];
    case 2
    Usig = 0.01*[21.62 33.93 36.71 38.10 39.08 40.87 41.50 42.29 43.25 45.89 47.05 49.21 49.80 51.58 54.56 55.61 57.93 60.12 62.69 70];
    Q = [8e4 3e4 1e4];
    case 3
    Usig = 0.01*[21.62 36.71 38.10 40.87 49.21];
    Q = [8e4 3e4 1e4
...
plot(tplotsbeforemodel,(Nw_ho),'b','LineWidth',3); grid on; hold on;
plot(tplotsbeforemodel,(Nw_lo),'r','LineWidth',3); grid on; hold on;
...
plot(tplotsbeforemodel,D_ho,'b','LineWidth',3); grid on; hold on;
plot(tplotsbeforemodel,D_lo,'r','LineWidth',3); grid on; hold on;
...
figure(2)
subplot(2,2,3)
plot(tplotsbeforemodel,Hm,'g','LineWidth',3); grid on; hold on;
plot(tplotsbeforemodel,H_ho,'b','LineWidth',3); grid on; hold on;
plot(tplotsbeforemodel,H_lo,'r','LineWidth',3); grid on; hold on;
plot(tplotsDATA,H_dado,'k.','MarkerSize',10); grid on; hold on;
plot(tplotsbeforemodel,[nlhos1; nlhos2],'color',[0.75, 0.75, 0],'LineWidth',3); grid on; hold on;
set(gca,'FontSize',20,'LineWidth',2,'FontWeight','Bold')
...
figure(2)
subplot(2,2,4)
plot(tplotsbeforemodel,Um,'g','LineWidth',3); grid on; hold on;
plot(tplotsbeforemodel,U_ho,'b','LineWidth',3); grid on; hold on;
plot(tplotsbeforemodel,U_lo,'r','LineWidth',3); grid on; hold on;
plot(tplotsDATA,U_dado,'k.','MarkerSize',10); grid on; hold on;
plot(tplotsbeforemodel,[nluti1; nluti2],'color',[0.75, 0.75, 0],'LineWidth',3); grid on; hold on;
set(gca,'FontSize',20,'LineWidth',2,'FontWeight','Bold')
...
plot(tplotsbeforemodel(2:end),(Nwm_i),'g','LineWidth',3); grid on; hold on;
plot(tplotsbeforemodel(2:end),(Nw_i_ho),'b','LineWidth',3); grid on; hold on;
plot(tplotsbeforemodel(2:end),(Nw_i_lo),'r','LineWidth',3); grid on; hold on;
plot(tplotsDATA(2:end),(Nw_dado),'k.','MarkerSize',10); grid on; hold on;
set(gca,'FontSize',20,'LineWidth',2,'FontWeight','Bold')
ylabel('New Cases')
xlim([tplotsbeforemodel(1) tplotsbeforemodel(end)])
...
plot(tplotsbeforemodel(2:end),(NwDm_i),'g','LineWidth',3); grid on; hold on;
plot(tplotsbeforemodel(2:end),(NwD_i_ho),'b','LineWidth',3); grid on; hold on;
plot(tplotsbeforemodel(2:end),(NwD_i_lo),'r','LineWidth',3); grid on; hold on;
plot(tplotsDATA(2:end),(NwD_dado),'k.','MarkerSize',10); grid on; hold on;
set(gca,'FontSize',20,'LineWidth',2,'FontWeight','Bold')
ylabel('New Deaths')
xlim([tplotsbeforemodel(1) tplotsbeforemodel(end)])
...
figure(1)
subplot(2,1,2)
plot(tplotsbeforemodel,[Psif; mean(Psif)*ones(npts-length(Psif),1)],'k--','LineWidth',2); grid on; hold on;
plot(tplotsbeforemodel,Psic_ho,'b','LineWidth',3); grid on; hold on;
plot(tplotsbeforemodel,Psic_lo,'r','LineWidth',3); grid on; hold on;
set(gca,'FontSize',20,'LineWidth',2,'FontWeight','Bold')
ylabel('SMRI')
xlim([tplotsbeforemodel(1) tplotsbeforemodel(end)])
ylim([0 1])
...
figure(1)
subplot(2,1,1)
plot(tplotsbeforemodel,uc_ho,'b','LineWidth',3); grid on; hold on;
plot(tplotsbeforemodel,uc_lo,'r','LineWidth',3); grid on; hold on;
plot(tplotsbeforemodel(1:length(strig)),strig,'k--','LineWidth',2); grid on; hold on;
set(gca,'FontSize',20,'LineWidth',2,'FontWeight','Bold')
...
figure(3)
plot(tplotsbeforemodel(1:length(Psi)),strig(1:length(Psi)),'LineWidth',3); grid on; hold on;
plot(tplotsbeforemodel(1:length(Psi)),Psi,'LineWidth',3); 
plot(tplotsbeforemodel(1:length(Psi)),Psi_fev*ones(1,size(Psi,1)),'--','LineWidth',3);
set(gca,'FontSize',20,'LineWidth',2,'FontWeight','Bold')
